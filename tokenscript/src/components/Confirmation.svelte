<script lang="ts">
	...
	export let operationalFee: string;
...
<div class="w-full">
	<button on:click={close} class="flex mt-12 ml-4">
		<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
			<g clip-path="url(#clip0_192_2372)">
				<path d="M14.396 15.4779L10.1977 11.2704L14.396 7.06295L13.1035 5.77045L7.6035 11.2704L13.1035 16.7704L14.396 15.4779Z" fill="#2D2D2D"/>
			</g>
			<defs>
	...
	<div class="flex flex-col items-center w-full px-3">
		...
		<div class="flex items-center text text-purple-400 bg-purple-100 border-2 border-purple-200 rounded-3xl px-6 py-1 mt-2">
		...
		<div class="w-full p-2 mt-5">
			<button type="button" on:click={confirm} class=" w-full py-4 bg-indigo-500 hover:bg-indigo-700 text-white rounded-xl text-xl">Confirm</button>
		</div>
	</div>
</div>
