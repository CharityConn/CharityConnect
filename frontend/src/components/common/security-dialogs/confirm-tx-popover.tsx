...
import { ITxValidationInfo } from '@tokenscript/engine-js/dist/lib.esm/security/TransactionValidator';
        ...
        {this.txInfo ? (
          <div class="tx-confirm-dialog">
            <div class="tx-confirm-info">
              ...
              <p>This token is trying to send a transaction to a contract that it is not signed for. Please proceed with caution.</p>
              <strong>Chain: </strong>
              <br />
              <span>
                {CHAIN_NAME_MAP[this.txInfo.chain]} (ID {this.txInfo.chain})
              </span>
              <br />
              <strong>Contract: </strong>
              <br />
              <span>{this.txInfo.toAddress}</span>
            </div>
            <div class="tx-confirm-buttons">
              <button class="btn btn-primary" onClick={() => this.confirm(true)}>
                I understand the risks
              </button>
              <button class="btn btn-primary" onClick={() => this.confirm(false)}>
                Abort
              </button>
            </div>
          </div>
