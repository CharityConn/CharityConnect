...
import { RequestFromView, ViewController, ViewEvent } from '@tokenscript/engine-js/dist/lib.esm/view/ViewController';
...
export abstract class AbstractViewBinding implements IViewBinding {
  ...
  get viewController() {
    if (!this._viewController) return this.tokenScript.getViewController();
